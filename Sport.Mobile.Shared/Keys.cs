...
namespace Sport.Mobile.Shared
{
	public class Keys
	{
        ...
        public static readonly string AzureDomainRemote = "https://jb69-sport.azurewebsites.net/";
		...
		public static readonly MobileServiceAuthenticationProvider AuthenticationProvider = MobileServiceAuthenticationProvider.Facebook;//http://jb69-sport.azurewebsites.net/.auth/login/facebook/callback
    }
}