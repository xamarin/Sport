...
namespace Sport.Mobile.Shared
{
	public class ChallengeViewModel : BaseViewModel
	{
		...
		public bool CanAccept
		{
			get
			{
				return Challenge != null && Challenge.ChallengeeAthleteId == App.Instance.CurrentAthlete.Id && !_challenge.IsAccepted && !Challenge.IsCompleted;
			}
		}
		...
		public bool CanDeclineAfterAccept
		{
			get
			{
				return Challenge != null && Challenge.ChallengeeAthleteId == App.Instance.CurrentAthlete.Id && Challenge.IsAccepted && !Challenge.IsCompleted;
			}
		}
		...
		public bool CanRevoke
		{
			get
			{
				return Challenge != null && Challenge.ChallengerAthleteId == App.Instance.CurrentAthlete.Id && !Challenge.IsCompleted;
			}
		}
		...
		public bool CanPostMatchResults
		{
			get
			{
				return Challenge != null && Challenge.IsAccepted && !Challenge.IsCompleted && Challenge.InvolvesAthlete(App.Instance.CurrentAthlete.Id);
			}
		}
		...
		public bool AwaitingDecision
		{
			get
			{
				return Challenge != null && !CanAccept && !CanPostMatchResults && Challenge.InvolvesAthlete(App.Instance.CurrentAthlete.Id) && !Challenge.IsCompleted;
			}
		}
		...
		public Athlete Opponent
		{
			get
			{
				return Challenge != null && Challenge.ChallengeeAthleteId != App.Instance.CurrentAthlete.Id ? Challenge?.ChallengeeAthlete : Challenge?.ChallengerAthlete;
			}
		}
